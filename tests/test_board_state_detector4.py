...
class TestBoardStateDetector4(TestCase):
    def setUp(self):
        self.image = Image.open('images/board4.png')
    ...
    def test_detect_column3(self):
        self.assertListEqual(
            [Icon.Yellow, Icon.Red, Icon.BombRed, Icon.Green, Icon.Pink, Icon.Yellow, Icon.Pink],
            self.detector.detect_column(self.image, 3))

    def test_detect_column4(self):
        self.assertListEqual(
            [Icon.Green, Icon.Purple, Icon.Yellow, Icon.Purple, Icon.Yellow, Icon.Green, Icon.Purple],
    ...
    def test_detect_column6(self):
        self.assertListEqual(
            [Icon.Empty, Icon.Yellow, Icon.Purple, Icon.Empty, Icon.Red, Icon.Pink, Icon.Red],
            self.detector.detect_column(self.image, 6))

    def test_detect_column7(self):
        self.assertListEqual(
            [Icon.Empty, Icon.Empty, Icon.Green, Icon.Empty, Icon.Empty, Icon.Pink, Icon.Empty],
